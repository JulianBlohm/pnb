    ...
    return (
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <h1 className={styles.h1_story2}>Anick</h1>
                <p>
                    ...
                    match what the typical boys body was. I did whatever I could
                    to change the physical side of who I was - just so that I
                    was accepted. The way you look and dress is seen as a
                    display of your gender identity. Growing up with a body
                    which I felt did not 'fit' me, meant I would always wear
                    baggy clothes and try to make what I was wearing seem
                    'interesting' but in a way to divert the attention from my
                    body.
                </p>
                <p>
                ...
                <p>
                    I believe that the concepts (of masculinity and femininity)
                    are relative and it's up to each individual to define what
                    it means for them. To me, the way I look and dress is
                    masculine and the way I act is fairly neutral - but other
                    people will always have their own ideas about who I am based
                ...
                <p>
                    ...
                    who challenge the norms of their time. Seeing difference on
                    display so openly is a wonderful thing and can make you feel
                    less alone.
                </p>
                <p>
                    We need to stop policing each other's bodies. There are
                    uncountable ways to be exactly who you are and the only
                    constant in life is change. If the way someone else
                ...
                <p>
                    ...
                    of myself. Please let people exist how they would like to.
                </p>
            </main>
